...
export default function Ramada5() {
  ...
  const slides = [
    { id: 1, color: 'from-yellow-400 to-yellow-600', label: 'Slide 1' },
    { id: 2, color: 'from-amber-400 to-amber-600', label: 'Slide 2' },
    { id: 3, color: 'from-orange-400 to-orange-600', label: 'Slide 3' },
    { id: 4, color: 'from-lime-400 to-lime-600', label: 'Slide 4' },
    { id: 5, color: 'from-yellow-500 to-yellow-700', label: 'Slide 5' },
    { id: 6, color: 'from-amber-500 to-amber-700', label: 'Slide 6' },
  ];
