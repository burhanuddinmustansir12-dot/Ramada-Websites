// Ramada Website 4 - Two Column Layout
...
export default function Ramada4() {
  ...
  const slides = [
    { id: 1, color: 'from-emerald-400 to-emerald-600', label: 'Slide 1' },
    { id: 2, color: 'from-green-400 to-green-600', label: 'Slide 2' },
    { id: 3, color: 'from-teal-400 to-teal-600', label: 'Slide 3' },
    { id: 4, color: 'from-cyan-400 to-cyan-600', label: 'Slide 4' },
    { id: 5, color: 'from-lime-400 to-lime-600', label: 'Slide 5' },
    { id: 6, color: 'from-green-500 to-green-700', label: 'Slide 6' },
  ];
