// Ramada Website 6 - Two Column Layout

import React, { useState } from 'react';

export default function Ramada6() {
  const [currentSlide, setCurrentSlide] = useState(0);
  
  const slides = [
    { id: 1, color: 'from-violet-400 to-violet-600', label: 'Slide 1' },
    { id: 2, color: 'from-purple-400 to-purple-600', label: 'Slide 2' },
    { id: 3, color: 'from-indigo-400 to-indigo-600', label: 'Slide 3' },
    { id: 4, color: 'from-blue-400 to-blue-600', label: 'Slide 4' },
    { id: 5, color: 'from-purple-500 to-purple-700', label: 'Slide 5' },
    { id: 6, color: 'from-violet-500 to-violet-700', label: 'Slide 6' },
  ];
